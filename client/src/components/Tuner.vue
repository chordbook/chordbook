...
<template>
  <div>
    <div class="cursor-default select-none">
      <div
        class="w-60 aspect-square mx-auto rounded-full shadow-lg border dark:bg-black/30 dark:border-black/60 relative flex"
      >
        <canvas
          ref="frequencyBars"
...
<style scoped>
.mask-image {
  mask-image: radial-gradient(#fff 30%, rgba(255, 255, 255, 0) 50%);
}
</style>
