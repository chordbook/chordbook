    ...
    <ion-content>
      ...
      <ion-list v-if="genre.tracks?.length > 0">
        <ion-list-header>
          ...
          <ion-button :router-link="{ name: 'genre.tracks', params: { id } }">See All</ion-button>
        </ion-list-header>
      ...
      <ion-list v-if="genre.artists?.length > 0">
        <ion-list-header>
          ...
          <ion-button :router-link="{ name: 'genre.artists', params: { id } }">See All</ion-button>
        </ion-list-header>
      ...
      <ion-list v-if="genre.albums?.length > 0">
        <ion-list-header>
          ...
          <ion-button :router-link="{ name: 'genre.albums', params: { id } }">See All</ion-button>
        </ion-list-header>
